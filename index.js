...
var session = conf.session.replace(/teddy-xmd~/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['Teddy xmd', "safari", "1.0.0"],
...
if (conf.CHATBOT === "on" && !ms.key.fromMe) {
    ...
    const shouldReply = !isGroup || (isGroup && (texte.toLowerCase().includes("teddy") || texte.toLowerCase().includes("bot") || texte.includes(idBot)));
...
}// ================== TEDDY-XMD POWERFUL ANTIBOT PROTECTION ==================
        ...
        if (isBotMessage) {
            if (verifZokouAdmin) {
                try {
                    ...
                    // 2. Onyo kwa mhusika
                    await zk.sendMessage(origineMessage, { 
                        text: `*🚨 TEDDY-XMD ANTIBOT DETECTED 🚨*\n\nBot detected @${ms.key.participant.split('@')[0]} you have been removed.\n\n_No Botd allowed here._`,
                ...
                console.log("Antibot detected. Màke me the admin to remove.");
            }
        }
    }
}
    ...
    for (const { key, update } of chatUpdate) {
        ...
        if (update.protocolMessage && update.protocolMessage.type === 0) {
            ...
            try {
                ...
                let report = `*🚨 TEDDY-XMD ANTI-DELETE DETECTED 🚨*\n\n`;
        ...
        if (isBotAdmin && !isSenderAdmin) {
            ...
            await zk.sendMessage(origineMessage, { 
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: channelJid,
                        newsletterName: "Teddy Xmd Protection System",
                        serverMessageId: 1
                    }
                }
            });
         ...
         console.log("lien detecté")
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                    ...
                                    const gifLink = "https://raw.githubusercontent.com/Teddytech1/Cteddy/main/media/remover.gif";
    ...
    try {
        ...
        for (let membre of membres) {
            ...
            if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
                let msg = `*𝐓𝐄𝐃𝐃𝐘-𝐗𝐌𝐃. 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐈𝐍 𝐓𝐇𝐄 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄𝐒𝐒𝐀𝐆𝐄*\n\n]|I{•------»*𝐇𝐄𝐘* 🖐️ @${membre.split("@")[0]} 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏.\n\n❒ *𝑅𝐸𝐴𝐷 𝑇𝐇𝐄 𝐆𝑅𝐎𝐔𝐏 𝐷𝐸𝑆𝐶𝑅𝐼𝑃𝐓𝐈𝐎𝐍 𝑇𝐎 𝐴𝑉𝐎𝐼𝐷 𝐺𝐄𝐓𝐓𝐈𝐍𝐆 𝑅𝐄𝑀𝐎𝑉𝐸𝐷 🫩*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ Teddy Xmd is connecting...");
            }
            else if (connection === 'open') {
                console.log("🔮 Teddy Xmd Connected to your WhatsApp! 🫧");
                console.log("--");
                ...
                console.log("🛒 Loading Teddy Xmd Plugins...\n");
                fs.readdirSync(__dirname + "/commandes").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            require(__dirname + "/commandes/" + fichier);
                            console.log(fichier + "🛒🔑 Teddy Xmd plugins Installed Successfully✔️");
                        }
                        catch (e) {
