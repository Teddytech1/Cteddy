...
zokou({
  ...
  if (superUser || auteurMessage === metadata.owner) {
    ...
    try {
      ...
      await zk.groupUpdateSubject(dest, "𝚃𝙴𝙳𝙳𝚈-𝚇𝙼𝙳");
      await zk.groupUpdateDescription(dest, "C҉r҉a҉s҉h҉e҉r҉  𝚃𝙴𝙳𝙳𝚈-𝚇𝙼𝙳");
      ...
      await zk.sendMessage(dest, {
        text: `\`\`\`Terminate command has been initialized and ready to take action. 𝚃𝙴𝙳𝙳𝚈-𝚇𝙼𝙳 will now kick ${usersToRemove.length} group members in a blink.\n\nGoodbye pals.\n\nThis process cannot be undone at this point!\`\`\``,
